...
export const EVA_MESSAGES = {
  ...
  auroraCore:
    "Сигнал от главного ядра Aurora подтверждён. Это не конец — стройте базу, исследуйте планету и собирайте ресурсы. Галактика ещё впереди.",
  auroraCoreRepeat: "Ядро Aurora уже просканировано. Продолжайте исследование.",
};
